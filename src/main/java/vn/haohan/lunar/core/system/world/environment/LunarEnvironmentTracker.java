...
public final class LunarEnvironmentTracker {
     ...
     */
    public void tickWorld(World world, LunarMobManager mobManager, BiConsumer<ActiveLunarMob, SkillTrigger> dispatcher) {
    ...
    private void dispatchToWorld(World world, LunarMobManager mobManager, SkillTrigger trigger, BiConsumer<ActiveLunarMob, SkillTrigger> dispatcher) {
        for (ActiveLunarMob mob : mobManager.snapshot()) {
