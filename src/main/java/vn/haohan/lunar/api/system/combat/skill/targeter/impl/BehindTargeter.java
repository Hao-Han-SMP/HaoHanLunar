...
/**
 * Selects targets located strictly behind the caster.
...
public final class BehindTargeter implements EntityTargeter {
    ...
    public Collection<LivingEntity> resolve(SkillCastContext context, Map<String, Object> parameters) {
        ...
        double rearAngle = parseAngle(parameters, 120.0);
        double minAngleThreshold = 180.0 - (rearAngle / 2.0); // e.g. 180 - 60 = 120 degrees
        double cosThreshold = Math.cos(Math.toRadians(minAngleThreshold));
