...
public final class MobOptionsListener implements Listener {
    ...
    public void onFriendlyFire(EntityDamageByEntityEvent event) {
        ...
        ActiveMob victimMob = getMob(event.getEntity());
        ActiveMob damagerMob = getMob(damager);
        if (victimMob != null && damagerMob != null) {
            if (victimMob.isSameFaction(damagerMob)) {
                MobOptions victimOpt = victimMob.options();
                MobOptions damagerOpt = damagerMob.options();
                if ((victimOpt != null && victimOpt.preventFriendlyFire()) ||
                    (damagerOpt != null && damagerOpt.preventFriendlyFire())) {
                    event.setCancelled(true);
                }
            }
        }
