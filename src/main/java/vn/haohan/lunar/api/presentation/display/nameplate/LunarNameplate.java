package vn.haohan.lunar.api.presentation.display.nameplate;
...
public final class LunarNameplate {
     ...
     */
    public static Component render(String template, ActiveMob mob) {
     ...
     */
    public static void apply(ActiveMob mob, String template) {
